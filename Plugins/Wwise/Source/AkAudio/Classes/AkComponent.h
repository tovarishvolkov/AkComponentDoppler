...
private:
	...
	*/
	...
	UPROPERTY() //AkComponent|Doppler Effect
	FVector SourcePrevPosition;
...
public:
	...
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "AkComponent|Doppler Effect")
	bool bDopplerEffect = true;

	/** Compute the velocity of the listener and source in the direction toward each other through the dot product?*/
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "AkComponent|Doppler Effect")
	bool bSpeedDotProduct = false;

	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "AkComponent|Doppler Effect")
	bool bDrawDebugDoppler = false;
	...
	/** Height offset for the listener's position */
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "AkComponent|Doppler Effect")
	...
	UPROPERTY(BlueprintReadOnly, Category = "AkComponent|Doppler Effect")
	float DopplerFactor;


	UFUNCTION(BlueprintCallable, Category = "Audiokinetic|AkComponent|Doppler Effect")
	void DopplerEffect(float DeltaTime);
